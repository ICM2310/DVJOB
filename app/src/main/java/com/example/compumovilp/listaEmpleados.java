...
public class listaEmpleados extends AppCompatActivity {
    ...
    private ActivityListaEmpleadosBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityListaEmpleadosBinding.inflate(getLayoutInflater());
    ...
    public void initUsers(){
        ...
        Query query = database.getReference(PATH_USERS).orderByChild("roll").equalTo(0);
